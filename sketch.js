...
B.position(425,100)
C=createElement("h2")
C.html("Q1) . Who is the Commander in Chief of the military? Choose one")
C.position(50,200)
D=createElement("h2")
D.html("a) The Vice-President")
D.position(50,250)
E=createElement("h2")
E.html("b) The Secretary of Defense")
E.position(50,300)
G=createElement("h2")
G.html("c) . The President")
G.position(50,350)
I=createElement("h2")
I.html("d) . The Attorney General")
I.position(50,400)
bp=createButton("SUBMIT")
bp.position(100,550)
